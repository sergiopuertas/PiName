...
from lib import buscar_en_pi, texto_a_numeros
...
name = texto_a_numeros(name)
if name:
    st.status(f"Representación numérica del nombre: {name}", expanded=True)
    result = buscar_en_pi(name)
